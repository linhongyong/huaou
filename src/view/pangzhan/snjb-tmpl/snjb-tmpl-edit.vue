  ...
  <div style="width: 90%; margin: 0 auto;">
    ...
    <div class=" padding-v-5">
      ...
      <div class="flex padding-v-5  padding-left-40">
        <div class=" padding-v-5">搅拌机型号:
          <Input v-model="obj.blenderModel" placeholder="" clearable :maxlength="200" style="width: 150px" />
        </div>
        <div class="padding-v-5 margin-l-10">工作状态:
          <Input v-model="obj.blenderState" placeholder="" clearable :maxlength="200" style="width: 150px" />
        </div>
        <div class="padding-v-5 margin-l-10">配套设备:
          <Input v-model="obj.matchingEquipment" placeholder="" clearable :maxlength="200" style="width: 150px" />
        </div>
      </div>
    </div>
    <div class=" padding-v-5">
      ...
      <div class="padding-v-5 flex padding-left-40">
        <div class="flex-3">水泥品种 :
          <Input v-model="obj.cementVarieties" placeholder="" clearable :maxlength="200" style="width: 100px" />
        </div>
        <div class="flex-3">供应单位 :
          <Input v-model="obj.supplier" placeholder="" clearable :maxlength="200" style="width: 100px" />
        </div>
        <div class="flex-3">质保、试验资料 :
          <Input v-model="obj.tryData" placeholder="" clearable :maxlength="200" style="width: 100px" />
        </div>
      </div>
    </div>
    <div class=" padding-v-5">
...
//      },
    ...
    methods: {
      handleSubmit(obj) {
        ...
        snjbTmplApi.updateSnjbTmpl(this.obj, (data) => {
          console.log(data);
