  ...
  <div style="width: 90%; margin: 0 auto;">
    <div class="flex padding-v-5" >
      <div class="flex-6 padding-v-5">模板名称：<Input v-model="obj.templateName" placeholder="" clearable :maxlength="200" style="width: 200px" /></div>
			<div class="flex-6 padding-v-5">工程地点：<Input v-model="obj.severalAxes " placeholder="" clearable :maxlength="200" style="width: 200px" /></div>
    </div>
		<!-- <div class="flex padding-v-5" >
...
/*      ruleCustom: {
  ...
  methods: {
    handleSubmit (obj) {
      ...
      yylTmplApi.addYylTmpl(this.obj, (data) => {
        console.log(data); 
