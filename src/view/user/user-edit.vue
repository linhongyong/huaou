  ...
  <Form :model="obj" ref="obj" :rules="ruleCustom">
    ...
    <div class="" style="min-height: 200px;">
      <div class=""  style="min-height: 100px; clear: both;padding: 0 20px; font-size: 18px;">
        ...
        <div class="" v-for="(item, index) in obj.roleSelectedList" style="float: left; padding-right: 20px;" v-on:click="reduceRole(index)" :key="item">
      ...
      <div class=""  style="min-height: 100px; clear: both;padding: 0 20px; font-size: 18px;">
        ...
        <div class="" v-for="(item, index) in obj.roleList" style="float: left; padding-right: 20px;" v-on:click="addRole(index)" :key="item">
